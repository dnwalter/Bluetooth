package com.voidtech.module_ble.core;
...
import com.voidtech.module_ble.callback.IRssiCallback;
import com.voidtech.module_ble.common.BleConfig;
import com.voidtech.module_ble.common.BleConstant;
import com.voidtech.module_ble.common.ConnectState;
...
import static com.voidtech.module_ble.common.BleConstant.MSG_CONNECT_RETRY;
import static com.voidtech.module_ble.common.BleConstant.MSG_CONNECT_TIMEOUT;
import static com.voidtech.module_ble.common.BleConstant.MSG_READ_DATA_RETRY;
import static com.voidtech.module_ble.common.BleConstant.MSG_READ_DATA_TIMEOUT;
import static com.voidtech.module_ble.common.BleConstant.MSG_RECEIVE_DATA_RETRY;
import static com.voidtech.module_ble.common.BleConstant.MSG_RECEIVE_DATA_TIMEOUT;
import static com.voidtech.module_ble.common.BleConstant.MSG_WRITE_DATA_RETRY;
import static com.voidtech.module_ble.common.BleConstant.MSG_WRITE_DATA_TIMEOUT;
...
public class DeviceMirror {
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
            ...
            if (newState == BluetoothGatt.STATE_CONNECTED) {
                ...
                if (connectCallback != null) {
                    ...
                    if (status == BluetoothGatt.GATT_SUCCESS) {
                        ...
                        connectCallback.onDisconnect(gatt.getDevice(), isActiveDisconnect);
                    } else {
        ...
        public void onServicesDiscovered(final BluetoothGatt gatt, final int status) {
            ...
            if (status == 0) {
                // onServicesDiscovered connectSuccess.
                bluetoothGatt = gatt;
    ...
    public synchronized void connect(IConnectCallback connectCallback) {
        if (connectState == ConnectState.CONNECT_SUCCESS || connectState == ConnectState.CONNECT_PROCESS
            ...
            // "this connect state is connecting, connectSuccess or current retry count less than config connect retry count."
            return;
        }
        if (handler != null) {
            handler.removeCallbacksAndMessages(null);
